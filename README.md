...
그래서 직접 만들었습니다. 548쪽짜리 교재 한 권을 실제로 번역해 **심각한 파손 0쪽 / 미번역 0쪽**까지 맞췄습니다. 위 이미지가 그 결과물입니다.
...
12GB 카드 기준 **500쪽 교재에 3~5시간**입니다. Linux에서 확인했고, macOS는 동작할 것으로 보이나 확인하지 않았습니다.
